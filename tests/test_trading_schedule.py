...
from zipline.utils.trading_schedule import ExchangeTradingSchedule
...
class TestExchangeTradingSchedule(TestCase):
    ...
    def test_nyse_data_availability_time(self):
        ...
        test_date = self.nyse_cal.normalize_date(test_dt)
    ...
    def test_nyse_execution_time(self):
        ...
        for dt in time_range:
            ...
            sched_exec = self.nyse_exchange_schedule.is_execution_time(dt)
            self.assertEqual(
                cal_open, sched_exec,
