...
class USEquityHistoryLoader(object):
    ...
    def _get_adjustments_in_range(self, assets, days, field):
        ...
        For the use of AdjustedAraryWindow in the loader, which looks back
    ...
    def _ensure_sliding_window(
            self, assets, start, end, size, start_ix, end_ix, field):
        ...
        block = SlidingWindow(window, start_ix, prefetch_end_ix)
    ...
    def history(self, assets, dts, field):
        ...
        block = self._ensure_sliding_window(
