...
class RiskMetricsPeriod(object):
    def __init__(self, start_date, end_date, returns, trading_schedule,
        ...
        trading_dates = trading_schedule.all_trading_dates
    ...
    def mask_returns_to_period(self, daily_returns, trading_dates):
        ...
        trade_day_mask = returns.index.normalize().isin(trading_dates)
